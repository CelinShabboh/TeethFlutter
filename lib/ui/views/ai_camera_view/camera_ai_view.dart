...
import 'package:flutter_app/ui/views/ai_camera_view/ai_camera_controller.dart';
...
class AiCameraView extends StatelessWidget {
  AiCameraView({super.key});
  AiCameraController controller =
      Get.put(AiCameraController());
  @override
